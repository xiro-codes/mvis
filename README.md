...
Once dependencies are installed and MPD is playing music to the FIFO, you can run the application directly with Cargo:
...
On the first run, the app will generate a `config.toml` file in the project root if one doesn't exist. You can customize the MPD connection details and default simulation parameters there.
